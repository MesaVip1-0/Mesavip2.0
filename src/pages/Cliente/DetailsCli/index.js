...
export default function DetailsCli() {
    ...
    // const [selectedIcons1, setSelectedIcons1] = useState({
    //     heart: false
    // });
    ...
    // const toggleIconSelection1 = (icon1) => {
    //     setSelectedIcons1((prevSelectedIcons1) => ({
    //         ...prevSelectedIcons1,
    //         [icon1]: !prevSelectedIcons1[icon1],
    //     }));
    // };
...
{/* 
                    <HeartButton
                        ...
                        onPress={() => toggleIconSelection1('heart')}
                    /> */}
                </ScrollView>
            </Animatable.View>
        </SafeAreaView>
